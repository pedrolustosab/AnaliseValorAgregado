...
Original file is located at
    https://colab.research.google.com/github/pedrolustosab/AnaliseValorAgregado/blob/main/EVA.ipynb
"""
...
df['ValorPlanejado'] = sigmoid(df['Medicao'], 16899000, 0.50, 12).round(2)
df['CustoReal'] = sigmoid(df['Medicao'], 17009000, 0.52, 11).round(2)
df['ValorAgregado'] = sigmoid(df['Medicao'], 14999000, 0.499, 12.15).round(2)

# Ajuste para valores NaN
df.loc[df['Medicao'] > 13, ['CustoReal', 'ValorAgregado']] = np.nan
